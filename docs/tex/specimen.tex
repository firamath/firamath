...
\usepackage{%
  expl3,xparse,
  ctexheading,fancyhdr,fontspec,
  array,longtable,multirow,hhline,
  xcolor,xcolor-material,
  geometry,hyperref}
...
\NewDocumentCommand \GlyphCount { }
  { Glyphs~ count:~ \ref*{count:glyph} }
\newcounter { glyph }
\setcounter { glyph } { -1 }
...
\cs_new_protected:Npn \xfonttable_unicode:nn #1#2
  {
    ...
    \fancyfoot [L] { \xfonttable_left_foot: }
...
\cs_new_protected:Npn \xfonttable_left_foot:
  {
    \mode_leave_vertical:
    \footnotesize
    \xfonttable_color_box:nn { nochar   @ bg } No~ Characters, \quad
...
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[R]{\footnotesize \itshape Copyright \copyright{} 2018 by Xiangdong Zeng}
...
%\newfontface\SymbolFont{unifont-10.0.05.ttf}[Path=D:/Fonts/GNU/]
...
%This is Fira Math, a sans-serif font with Unicode math support.
%
%\begin{center}
%  \fonttablelegend{No Characters}{nochar@bg}
%  \fonttablelegend{Reserved Code Points}{reserved@bg}
%  \fonttablelegend{Control Codes}{control@bg}
%\end{center}
