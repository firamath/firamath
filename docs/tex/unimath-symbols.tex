...
\defmathfont{pagella}{texgyrepagella-math.otf}{AA66CC}
%\defmathfont{euler}{euler.otf}{CC66CC}
%\defmathfont{dejavu}{texgyredejavu-math.otf}{AACC66}
\defmathfont{firaT}{FiraMath-Thin.otf}{6666CC}[Path=../assets/]
\defmathfont{firaL}{FiraMath-Light.otf}{6666CC}[Path=../assets/]
\defmathfont{firaR}{FiraMath-Regular.otf}{6666CC}[Path=../assets/]
\defmathfont{firaM}{FiraMath-Medium.otf}{6666CC}[Path=../assets/]
\defmathfont{firaB}{FiraMath-Bold.otf}{6666CC}[Path=../assets/]
...
\def\TABLE{%
  ...
  \begin{longtabu}[l]{@{}lcccccccclX[l]@{}}
    ...
    \textsc{usv} & M & X & P & F & F & F & F & F & Macro & Description \\
    \midrule \endhead
    \INPUT\\
    \bottomrule
  \end{longtabu}
...
\item[F] \mathversion{firaT} $\mathup{Fira\ Math\ Thin}$ (\ref{count:firaT})
\item[F] \mathversion{firaL} $\mathup{Fira\ Math\ Light}$ (\ref{count:firaL})
\item[F] \mathversion{firaR} $\mathup{Fira\ Math\ Regular}$ (\ref{count:firaR})
\item[F] \mathversion{firaM} $\mathup{Fira\ Math\ Medium}$ (\ref{count:firaM})
\item[F] \mathversion{firaB} $\mathup{Fira\ Math\ Bold}$ (\ref{count:firaB})
\end{itemize}
...
\refstepcounter{firaT}\label{count:firaT}
\refstepcounter{firaL}\label{count:firaL}
\refstepcounter{firaR}\label{count:firaR}
\refstepcounter{firaM}\label{count:firaM}
\refstepcounter{firaB}\label{count:firaB}
