...
\setmathfont{FiraMath-Regular.otf}[BoldFont = *, Path=../docs/assets/]
\setmathfont{FiraMath-Regular.otf}[BoldFont = *, Path=../docs/assets/, StylisticSet=1, version=upintegral]
\setmathfont{FiraMath-Regular.otf}[BoldFont = *, Path=../docs/assets/, StylisticSet=2, version=hbar]
\setmathfont{FiraMath-Regular.otf}[BoldFont = *, Path=../docs/assets/, StylisticSet=3, version=complement]
\newfontface\firatext{FiraMath-Regular.otf}[BoldFont = *, Path=../docs/assets/]
