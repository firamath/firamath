...
\setmathfont{fira-math.otf}[BoldFont = *, Path=../docs/assets/, StylisticSet=1, version=upintegral]
\setmathfont{fira-math.otf}[BoldFont = *, Path=../docs/assets/, StylisticSet=2, version=hbar]
...
\begin{itemize}
  ...
  \item Non-ligature (math): $ \symrm{\ligaturetext} + \ligaturetext $
