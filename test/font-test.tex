...
\setmathfont{fira-math.otf}[BoldFont = *, Path=../assets/]
\setmathfont{fira-math.otf}[BoldFont = *, Path=../assets/, version=upintegral, StylisticSet=1]
\newfontface\firatext{fira-math.otf}[BoldFont = *, Path=../assets/]
