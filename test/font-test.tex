...
\str_set:Nn \l_fonttest_font_str { fira }
...
\str_if_eq:VnTF \l_fonttest_font_str { fira }
  {
    ...
    \def\SSTY{}
    \ifdefined\SSTY
      \setmathfont{FiraMath-\WIEGHT.otf}[BoldFont = *, Path=../docs/assets/]
      \setmathfont{FiraMath-\WIEGHT.otf}[BoldFont = *, Path=../docs/assets/, StylisticSet=1, version=upintegral]
      \setmathfont{FiraMath-\WIEGHT.otf}[BoldFont = *, Path=../docs/assets/, StylisticSet=2, version=hbar]
      \setmathfont{FiraMath-\WIEGHT.otf}[BoldFont = *, Path=../docs/assets/, StylisticSet=3, version=complement]
    \else
      \setmathfont{FiraMath-\WIEGHT.otf}[BoldFont = *, Path=../docs/assets/]
      \setmathfont{FiraMath-\WIEGHT.otf}[BoldFont = *, Path=../docs/assets/, version=upintegral]
      \setmathfont{FiraMath-\WIEGHT.otf}[BoldFont = *, Path=../docs/assets/, version=hbar]
      \setmathfont{FiraMath-\WIEGHT.otf}[BoldFont = *, Path=../docs/assets/, version=complement]
    \fi
...
\begin{itemize}
  ...
  \item Radical:
        % Not necessary after unicode-math v0.8m.
        % \begingroup
